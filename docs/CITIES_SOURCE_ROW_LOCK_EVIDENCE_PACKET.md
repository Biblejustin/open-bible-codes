...
| 11 | `cities_source_row_lock_011` | cities_pdf_dp365a_p12_17 | 3 | `exception_note_candidate_page` | archive | `127d829147cb` | `reports/cities_pdf_recovery_probe/unreadable_pdf_ocr_review/page_images/cities_pdf_dp365a_p12_17_p003.png` | `locked` | verify archived PDF checksum, rendered page image, visual page role, and admissibility for cities_source_row_lock_011; do not transcribe body text |
...
| 14 | `cities_source_row_lock_014` | cities_pdf_dp365a_p12_17 | 6 | `exception_note_candidate_page` | archive | `127d829147cb` | `reports/cities_pdf_recovery_probe/unreadable_pdf_ocr_review/page_images/cities_pdf_dp365a_p12_17_p006.png` | `locked` | verify archived PDF checksum, rendered page image, visual page role, and admissibility for cities_source_row_lock_014; do not transcribe body text |
