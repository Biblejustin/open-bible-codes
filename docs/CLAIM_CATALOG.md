...
| CRD exact center-word broad screen | `partially_reproducible` | 1 | Self-surface and concept-surface CRD produce identical 1044 Bible exact center-word rows across 131 term IDs and 76 distinct normalized surface forms; exact center-word rows are occurrence and density flags, not claim-level proof. |
