...
| Aggregate statistic and permutation | `diagnostic_not_claim_grade` | `claim_grade_ready,permutation_locked` | `false` | Aggregate statistic and permutation: status diagnostic_not_claim_grade is not claim-ready; requires one of claim_grade_ready,permutation_locked |
