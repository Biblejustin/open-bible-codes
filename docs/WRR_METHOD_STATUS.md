...
| Aggregate statistic and permutation | `source_locked_not_built` | Published Table 3 ranks are source-audited, but local claim-grade P1..P4 and date-permutation runners are not built. | Source Table 3: G min P4 rank 4, p0=0.000016; controls: R p0=1.459436, T p0=1.108412, I p0=3.599320, W p0=2.064392, U p0=1.102964, V p0=0.847108; no local aggregate recomputation from defined c-values | Implement only after final pair universe and corrected-distance values are locked. |
