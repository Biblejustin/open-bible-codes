# Greek Surface Length-4 Vocabulary Control Evaluation
...
Matched controls per target range from 200 to 200. The best possible add-one empirical p-values in this run are 0.004975.

| Term | Concept | Observed all-source | Controls >= observed | p_ge | q | Read |
| --- | --- | ---: | ---: | ---: | ---: | --- |
| `αμην` (amen; English: Amen) | Amen | 11 | 69 | 0.348259 | 0.441127 | matched controls overlap target |
| `αραμ` (aram; English: Aram) | Aram | 3 | 34 | 0.174129 | 0.365671 | matched controls overlap target |
| `ασηρ` (aser; English: Asher) | Asher | 2 | 7 | 0.039801 | 0.278607 | exploratory matched controls below p<=0.05; still post-screen |
