...
| `crd_exact_center_word_broad_screen` | `partially_reproducible` | Self-surface and concept-surface CRD produce identical 1044 Bible exact center-word term-hit rows across 131 term IDs plus 76 distinct normalized surface forms and 425 distinct normalized surface hit paths; center-word-only summary has 120 terms above secular max and 94 Bible-positive secular-zero terms; concept expansion changes zero exact center-word exceedance decisions | `docs/CRD_CENTER_WORD_SELF_VS_CONCEPT_FINDINGS.md` |
