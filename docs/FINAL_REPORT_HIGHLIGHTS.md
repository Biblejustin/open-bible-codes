...
| `critical_omission_breakage` | `partially_reproducible` | Five follow-up analyses now run through a shared break engine; base omitted-verse breakage has 645 broken TR hits; 1000-shuffle null gives p_ge 0.9710 and null median 727; reverse cross-tradition length-stratified and disputed-passage override reports exist | `docs/CRITICAL_OMISSION_BREAKS.md` |
