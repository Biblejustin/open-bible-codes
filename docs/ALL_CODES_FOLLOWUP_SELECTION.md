...
| 53 | hebrew_screening | `center_verse_exact` | all_source | `lord_h` | Lord | -2 | 1Kgs 20:9 | `הדד` |
| 54 | hebrew_screening | `center_verse_same_concept` | all_source | `rome_h` | Rome | -6 | 1Kgs 7:40 | `המזרקות` |
...
| 59 | hebrew_screening | `center_verse_same_category` | all_source | `timothy_h` | Timothy | 16 | Gen 30:20 | `שמו` |
...
| 62 | hebrew_screening | `span_exact` | all_source | `mary_h` | Mary | -3 | Mic 6:5 | `זכר` |
...
| 80 | hebrew_theology | `span_same_category` | all_source | `htp_covenant_h` | Covenant | -10 | Prov 30:4 | `שמימ` |
