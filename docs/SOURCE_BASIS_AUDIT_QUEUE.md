...
| Supplemental open English controls | 15 | 0 | 15 |
...
| ACV, NHEB, ROTHERHAM | `broad_tradition` | CrossWire module pages identify these texts as public-domain English Bible modules; import uses the corresponding Zefania XML packages and keeps exact source-edition claims broad unless stated by the module page: <https://crosswire.org/sword/modules/ModInfo.jsp?modName=ACV>, <https://crosswire.org/sword/modules/ModInfo.jsp?modName=NHEB>, and <https://crosswire.org/sword/modules/ModInfo.jsp?modName=Rotherham> |
