...
- path rows checked: 305
- selected rows checked: 82
- selected rows with extensions: 68
- extension rows: 672
- selected rows with compound extensions: 13
- compound extension rows containing hidden term: 55
- max extension length: 5
- extension rows by corpus: `{'BYZ_NT': 28, 'EBIBLE_WLC': 99, 'KJV': 35, 'MAM': 105, 'MT_WLC': 112, 'SBLGNT': 26, 'TCG_NT': 28, 'TR_NT': 28, 'UHB': 100, 'UXLC': 111}`
- extension rows by type: `{'after_match': 302, 'before_match': 315, 'before_plus_term': 39, 'term_plus_after': 16}`
...
| 73 | hebrew_theology | `center_word_exact` | `יהוה` (YHWH; English: YHWH) | UXLC | `before_plus_term` | `עדיהוה` (dyhwh) | `phrase_2` | 6 | עַד־ יְהוָ֣ה; עַד־ יְהוָ֤ה; עֵ֧ד יְהוָ֣ה; עַד־ יְהוָ֔ה; עַ֖ד יְהוָ֣ה |
...
| 69 | hebrew_screening | `hidden_path_only` | `יומיהוה` (yom YHWH; English: Day Of The Lord) | UXLC | `before_plus_term` | `היומיהוה` (hayom YHWH; English: the day of YHWH) | `phrase_2` | 3 | הַיּ֔וֹם יְהוָ֖ה; הַיּ֗וֹם יְהוָ֛ה |
...
| 76 | hebrew_theology | `center_word_same_category` | `ברית` (bryt; English: Covenant) | UXLC | `term_plus_after` | `בריתו` (brytw) | `word` | 17 | בְּרִית֔וֹ; בְּרִית֗וֹ; בְּרִית֛וֹ; בְּרִיתֽוֹ׃; בְּרִיתוֹ֙ |
| 79 | hebrew_theology | `center_verse_same_category` | `חכמה` (chkmh; English: Wisdom) | UXLC | `before_plus_term` | `וחכמה` (wchkmh) | `word` | 6 | וְ֝חָכְמָ֗ה; וְחָכְמָ֔ה; וְחָכְמָ֑ה; וְחָכְמָ֥ה; וְחָכְמָֽה׃ |
...
| 80 | hebrew_theology | `span_same_category` | `משיח` (Mashiach; English: Messiah) | UXLC | `before_match` | `שבנא` (shbn) | `phrase_2+word` | 6 | שֶׁבְנָ֖א; שֶׁבְנָ֣א; שֵֽׁב־ נָ֣א; שֵׁ֣ב נָ֔א |
| 81 | hebrew_theology | `span_same_category` | `משיח` (Mashiach; English: Messiah) | UXLC | `after_match` | `לובו` (lwbw) | `phrase_2` | 1 | ל֖וֹ בּֽוֹ׃ |
...
| 72 | hebrew_theology | `center_word_exact` | `יהוה` (YHWH; English: YHWH) | UXLC | `before_match` | `הילק` (hylq) | `word` | 3 | הַיָּ֑לֶק; הַיֶּ֔לֶק; הַיֶּ֖לֶק |
| 77 | hebrew_theology | `center_verse_same_category` | `אהבה` (hbh; English: Love) | UXLC | `after_match` | `הלהב` (hlhb) | `word` | 3 | הַלַּ֗הַב; הַלַּ֔הַב; הַלַּ֜הַב |
| 70 | hebrew_screening | `hidden_path_only` | `קברריק` (qbrryq; English: Empty Tomb) | UXLC | `after_match` | `שרית` (shryt) | `word` | 2 | שָׂרִ֧יתָ; שֵׁרִ֧ית |
| 55 | hebrew_screening | `center_verse_same_concept` | `התשח` (htshch; English: Hebrew year 5708) | UXLC | `before_match` | `יברא` (ybr) | `word` | 1 | יִבְרָ֣א |
...
| 53 | hebrew_screening | `center_verse_exact` | `יואל` (ywl; English: Joel) | UXLC | `after_match` | `נזמ` (nzm) | `word` | 7 | נֶ֣זֶם; נֶ֥זֶם; נֶ֙זֶם֙ |
| 66 | hebrew_screening | `span_same_category` | `פתרסימ` (ptrsym; English: Pathrusim) | UXLC | `before_match` | `עכנ` (kn) | `word` | 6 | עָכָ֣ן; עָכָ֞ן; עָכָ֗ן; עָכָ֛ן |
| 67 | hebrew_screening | `span_same_category` | `טימותי` (tymwty; English: Timothy) | UXLC | `before_match` | `חלי` (chly) | `word` | 5 | חֹ֑לִי; חֳלִי֙; חֳלִ֥י; חֳלִ֖י |
...
| 75 | hebrew_theology | `center_word_same_category` | `תורה` (twrh; English: Torah) | UXLC | `after_match` | `ואח` (wch) | `word` | 2 | וְאָ֥ח; וָאָ֣ח |
...
| 78 | hebrew_theology | `center_verse_same_category` | `אהבה` (hbh; English: Love) | UXLC | `after_match` | `יבל` (ybl) | `word` | 1 | יָבָ֑ל |
| 26 | greek_screening | `center_word_same_category` | `ιωυαν` (Iouan; English: Javan) | TR_NT | `after_match` | `ηα` (ea) | `phrase_2` | 2 | ἢ ἃ; Ἢ ἃ |
| 68 | hebrew_screening | `span_same_category` | `תתתתתכז` (tttttkz; English: Gregorian 2027 additive) | UXLC | `after_match` | `שה` (shh; English: Lamb) | `word` | 24 | שֶׂ֣ה; שֶׂה־; שֶׂ֥ה; שֶׂ֔ה; שֶׂ֖ה |
| 65 | hebrew_screening | `span_same_concept` | `תתתתתא` (ttttt; English: Gregorian 2001) | UXLC | `after_match` | `חת` (Chet; English: Heth) | `word` | 16 | חֵֽת׃; חֵ֖ת; חֵ֛ת; חֵ֑ת; חֵ֔ת |
...
| 82 | hebrew_theology | `span_same_category` | `ברית` (bryt; English: Covenant) | UXLC | `after_match` | `דא` (d) | `word` | 5 | דָא־; דָּ֥א; דָּֽא׃; דָ֔א |
| 21 | english_screening | `hidden_path_only` | `cush` | KJV | `before_match` | `ur` | `word` | 5 | Ur; Ur, |
| 64 | hebrew_screening | `span_same_concept` | `התשח` (htshch; English: Hebrew year 5708) | UXLC | `before_match` | `הכ` (hk) | `word` | 4 | הַךְ־; הַ֨ךְ; הַ֤ךְ |
| 56 | hebrew_screening | `center_verse_same_concept` | `רומי` (rwmy; English: Rome) | UXLC | `before_match` | `תו` (tav; English: mark/sign) | `word` | 1 | תָּ֜ו |
...
| 73 | UXLC | `יהוה` (YHWH; English: YHWH) | `before_plus_term` | `עדיהוה` (dyhwh) | `phrase_2` | 6 | Deut 4:30; Deut 30:2; 1 Sam 12:5; Isa 19:22; Hos 14:2 |
...
| 73 | UHB | `יהוה` (YHWH; English: YHWH) | `before_plus_term` | `עדיהוה` (dyhwh) | `phrase_2+word` | 6 | DEU 4:30; DEU 30:2; ISA 19:22; LAM 3:40; 1SA 12:5 |
...
| 73 | MT_WLC | `יהוה` (YHWH; English: YHWH) | `before_plus_term` | `עדיהוה` (dyhwh) | `phrase_2` | 6 | Deut 4:30; Deut 30:2; 1Sam 12:5; Isa 19:22; Hos 14:2 |
...
| 73 | MAM | `יהוה` (YHWH; English: YHWH) | `before_plus_term` | `עדיהוה` (dyhwh) | `phrase_2+word` | 6 | Deut 4:30; Deut 30:2; Isa 19:22; Lam 3:40; 1 Sam 12:5 |
...
| 73 | EBIBLE_WLC | `יהוה` (YHWH; English: YHWH) | `before_plus_term` | `עדיהוה` (dyhwh) | `phrase_2+word` | 6 | DEU 4:30; DEU 30:2; ISA 19:22; LAM 3:40; 1SA 12:5 |
...
| 69 | UXLC | `יומיהוה` (yom YHWH; English: Day Of The Lord) | `before_plus_term` | `היומיהוה` (hayom YHWH; English: the day of YHWH) | `phrase_2` | 3 | Lev 9:4; 2 Kings 2:3; 2 Kings 2:5 |
| 69 | UHB | `יומיהוה` (yom YHWH; English: Day Of The Lord) | `before_plus_term` | `היומיהוה` (hayom YHWH; English: the day of YHWH) | `phrase_2` | 3 | LEV 9:4; 2KI 2:3; 2KI 2:5 |
| 69 | MT_WLC | `יומיהוה` (yom YHWH; English: Day Of The Lord) | `before_plus_term` | `היומיהוה` (hayom YHWH; English: the day of YHWH) | `phrase_2` | 3 | Lev 9:4; 2Kgs 2:3; 2Kgs 2:5 |
| 69 | MAM | `יומיהוה` (yom YHWH; English: Day Of The Lord) | `before_plus_term` | `היומיהוה` (hayom YHWH; English: the day of YHWH) | `phrase_2` | 3 | Lev 9:4; 2 Kgs 2:3; 2 Kgs 2:5 |
| 69 | EBIBLE_WLC | `יומיהוה` (yom YHWH; English: Day Of The Lord) | `before_plus_term` | `היומיהוה` (hayom YHWH; English: the day of YHWH) | `phrase_2` | 3 | LEV 9:4; 2KI 2:3; 2KI 2:5 |
| 45 | UXLC | `יהוה` (YHWH; English: YHWH) | `before_plus_term` | `דיהוה` (dyhwh) | `phrase_2` | 1 | Dan 5:19 |
| 73 | UXLC | `יהוה` (YHWH; English: YHWH) | `before_plus_term` | `דיהוה` (dyhwh) | `phrase_2` | 1 | Dan 5:19 |
| 45 | MT_WLC | `יהוה` (YHWH; English: YHWH) | `before_plus_term` | `דיהוה` (dyhwh) | `phrase_2` | 1 | Dan 5:19 |
| 73 | MT_WLC | `יהוה` (YHWH; English: YHWH) | `before_plus_term` | `דיהוה` (dyhwh) | `phrase_2` | 1 | Dan 5:19 |
...
| 76 | UXLC | `ברית` (bryt; English: Covenant) | `term_plus_after` | `בריתו` (brytw) | `word` | 17 | Ex 2:24; Deut 4:13; Deut 8:18; Deut 17:2; 2 Kings 13:23 |
| 76 | MT_WLC | `ברית` (bryt; English: Covenant) | `term_plus_after` | `בריתו` (brytw) | `word` | 17 | Exod 2:24; Deut 4:13; Deut 8:18; Deut 17:2; 2Kgs 13:23 |
| 15 | KJV | `wine` | `before_plus_term` | `swine` | `word` | 16 | LEV 11:7; DEU 14:8; MAT 7:6; MAT 8:30; MAT 8:31 |
| 76 | UHB | `ברית` (bryt; English: Covenant) | `term_plus_after` | `בריתו` (brytw) | `word` | 10 | DEU 17:2; 2KI 13:23; 1CH 16:15; PSA 25:10; PSA 55:20 |
| 76 | MAM | `ברית` (bryt; English: Covenant) | `term_plus_after` | `בריתו` (brytw) | `word` | 10 | Deut 17:2; 2 Kgs 13:23; Ps 25:10; Ps 55:21; Ps 103:18 |
| 76 | EBIBLE_WLC | `ברית` (bryt; English: Covenant) | `term_plus_after` | `בריתו` (brytw) | `word` | 10 | DEU 17:2; 2KI 13:23; 1CH 16:15; PSA 25:10; PSA 55:21 |
| 79 | UXLC | `חכמה` (chkmh; English: Wisdom) | `before_plus_term` | `וחכמה` (wchkmh) | `word` | 6 | Prov 10:23; Eccl 9:10; Dan 1:17; Dan 5:11; Dan 5:14 |
| 79 | UHB | `חכמה` (chkmh; English: Wisdom) | `before_plus_term` | `וחכמה` (wchkmh) | `word` | 6 | 2CH 9:22; PRO 10:23; ECC 9:10; DAN 1:17; DAN 5:11 |
| 79 | MT_WLC | `חכמה` (chkmh; English: Wisdom) | `before_plus_term` | `וחכמה` (wchkmh) | `word` | 6 | Prov 10:23; Eccl 9:10; Dan 1:17; Dan 5:11; Dan 5:14 |
| 79 | MAM | `חכמה` (chkmh; English: Wisdom) | `before_plus_term` | `וחכמה` (wchkmh) | `word` | 6 | Prov 10:23; Eccl 9:10; Dan 1:17; Dan 5:11; Dan 5:14 |
| 79 | EBIBLE_WLC | `חכמה` (chkmh; English: Wisdom) | `before_plus_term` | `וחכמה` (wchkmh) | `word` | 6 | 2CH 9:22; PRO 10:23; ECC 9:10; DAN 1:17; DAN 5:11 |
...
| 73 | UHB | `יהוה` (YHWH; English: YHWH) | `before_plus_term` | `דיהוה` (dyhwh) | `word` | 1 | DAN 5:19 |
...
| 73 | EBIBLE_WLC | `יהוה` (YHWH; English: YHWH) | `before_plus_term` | `דיהוה` (dyhwh) | `word` | 1 | DAN 5:19 |
