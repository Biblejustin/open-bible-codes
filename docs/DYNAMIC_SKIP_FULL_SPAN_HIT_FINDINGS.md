...
| TCG_NT | `dyn_netanyahu_g` | 1 | 50218 | ROM 4:2=1 | `καυχημα` (kauchema)=1 |
| TR_NT | `dyn_netanyahu_g` | 1 | 71517 | ACT 9:43=1 | `εγενετο` (egeneto)=1 |
| KJV | `dyn_simsberry_e` | 2 | 144748 | PSA 48:5=1; 1CH 12:17=1 | troubled=1; be=1 |
| LXX | `dyn_netanyahu_g` | 2 | 35170 | LEV 25:39=1; 1SA 22:23=1 | `σοι` (soi)=1; `ζητω` (zeto)=1 |
...
| GRC_PERSEUS_ODYSSEY | `dyn_christ_g` | 32 | 1066 | Perseus Odyssey=32 | `κτεατεσσιν` (kteatessin)=2; `αυτοσ` (autos)=2; `νεστορα` (nestora)=1; `σημανεω` (semaneo)=1; `φθισεσθαι` (phthisesthai)=1 |
| GRC_PERSEUS_ILIAD | `dyn_christ_g` | 69 | 595 | Perseus Iliad=69 | `διοσ` (dios)=2; `σε` (se)=2; `ωσ` (os)=2; `τελαμωνιοσ` (telamonios)=1; `χροοσ` (chroos)=1 |
| TR_NT | `dyn_christ_g` | 73 | 193 | 2CO 12:11=2; ACT 4:7=1; ACT 21:24=1; ACT 24:16=1; ACT 9:43=1 | `εισ` (eis)=4; `πατροσ` (patros)=2; `αυτουσ` (autous)=2; `εστιν` (estin)=2; `ιησουσ` (Iesous; English: Jesus/Joshua)=2 |
| BYZ_NT | `dyn_christ_g` | 79 | 1414 | ACT 6:9=1; ACT 13:38=1; JHN 3:26=1; JHN 6:34=1; JHN 9:15=1 | `αυτοισ` (autois)=4; `αυτουσ` (autous)=3; `τησ` (tes)=2; `τουσ` (tous)=2; `οιτινεσ` (oitines)=2 |
| TCG_NT | `dyn_christ_g` | 80 | 3289 | ACT 4:23=1; ACT 5:3=1; ACT 16:38=1; ACT 4:28=1; JHN 16:14=1 | `πιστεωσ` (pisteos)=3; `ωσ` (os)=3; `τουσ` (tous)=2; `απολυθεντεσ` (apoluthentes)=1; `νοσφισασθαι` (nosphisasthai)=1 |
| SBLGNT | `dyn_christ_g` | 85 | 737 | Acts 27:16=2; Acts 7:45=1; Acts 13:28=1; Acts 16:23=1; Acts 12:3=1 | `εισ` (eis)=6; `τησ` (tes)=4; `πατροσ` (patros)=2; `ουτωσ` (outos)=2; `υμασ` (umas)=2 |
...
| --- | --- | --- | ---: | --- | --- | --- | --- |
| `exact_center_word` | BYZ_NT | `dyn_christ_g` | -7527 | 2CO 7:14 | 1CO 12:12 | ROM 16:18 | `χριστοσ` (Christos; English: Christ) |
| `exact_center_word` | TCG_NT | `dyn_christ_g` | 9387 | 2CO 12:16 | PHP 2:11 | 1TI 3:16 | `Χριστός,` (Christos; English: Christ) |
| `exact_center_word` | LXX | `dyn_christ_g` | 65649 | JOS 13:27 | 1SA 24:11 | 1KI 20:10 | `χριστὸς` (Christos; English: Christ) |
| `exact_center_word` | ENG_PG_MOBY_DICK | `dyn_christ_e` | 116374 | PG Moby Dick | PG Moby Dick | PG Moby Dick | Christ! |
| `exact_center_word` | SBLGNT | `dyn_jesus_g` | -120184 | 1Pet 4:14 | John 21:4 | Matt 5:33 | `Ἰησοῦς` (Iesous; English: Jesus) |
| `exact_center_word` | SBLGNT | `dyn_jesus_g` | -111545 | Heb 11:7 | John 20:15 | Matt 12:10 | `Ἰησοῦς·` (Iesous; English: Jesus) |
| `exact_center_word` | SBLGNT | `dyn_jesus_g` | -103617 | Col 3:22 | John 9:41 | Matt 7:29 | `Ἰησοῦς·` (Iesous; English: Jesus) |
| `exact_center_word` | SBLGNT | `dyn_jesus_g` | -93353 | Eph 1:5 | John 9:39 | Matt 15:12 | `Ἰησοῦς·` (Iesous; English: Jesus) |
| `exact_center_word` | SBLGNT | `dyn_jesus_g` | -87337 | Gal 4:1 | John 12:23 | Matt 23:20 | `Ἰησοῦς` (Iesous; English: Jesus) |
| `exact_center_word` | BYZ_NT | `dyn_jesus_g` | -111783 | HEB 4:10 | JHN 17:1 | MAT 10:15 | `ιησουσ` (Iesous; English: Jesus) |
| `exact_center_word` | BYZ_NT | `dyn_jesus_g` | -110755 | 1TI 4:14 | JHN 11:5 | MAT 5:17 | `ιησουσ` (Iesous; English: Jesus) |
| `exact_center_word` | BYZ_NT | `dyn_jesus_g` | -108780 | COL 4:15 | JHN 8:1 | MAT 2:6 | `ιησουσ` (Iesous; English: Jesus) |
| `exact_center_word` | BYZ_NT | `dyn_jesus_g` | -101495 | GAL 4:10 | JHN 4:48 | MAT 4:6 | `ιησουσ` (Iesous; English: Jesus) |
| `exact_center_word` | BYZ_NT | `dyn_jesus_g` | -90160 | EPH 3:13 | JHN 14:6 | MAT 24:22 | `ιησουσ` (Iesous; English: Jesus) |
| `exact_center_word` | TR_NT | `dyn_jesus_g` | -103329 | 1TI 6:2 | JHN 18:8 | MAT 17:2 | `Ἰησοῦς` (Iesous; English: Jesus) |
| `exact_center_word` | TR_NT | `dyn_jesus_g` | -100505 | COL 1:6 | JHN 11:32 | MAT 13:22 | `Ἰησοῦς` (Iesous; English: Jesus) |
| `exact_center_word` | TR_NT | `dyn_jesus_g` | -100098 | PHP 3:20 | JHN 11:13 | MAT 13:18 | `Ἰησοῦς` (Iesous; English: Jesus) |
| `exact_center_word` | TR_NT | `dyn_jesus_g` | -76588 | 1CO 10:27 | JHN 8:49 | MAT 27:24 | `Ἰησοῦς` (Iesous; English: Jesus) |
| `exact_center_word` | TR_NT | `dyn_jesus_g` | -68034 | ACT 9:2 | LUK 7:22 | MAT 4:10 | `Ἰησοῦς` (Iesous; English: Jesus) |
| `exact_center_word` | TCG_NT | `dyn_jesus_g` | -123507 | 1PE 4:2 | JHN 19:9 | MAT 1:18 | `Ἰησοῦς` (Iesous; English: Jesus) |
| `exact_center_word` | TCG_NT | `dyn_jesus_g` | -122663 | 1PE 2:12 | JHN 18:37 | MAT 2:3 | `Ἰησοῦς,` (Iesous; English: Jesus) |
| `exact_center_word` | TCG_NT | `dyn_jesus_g` | -122037 | 1PE 5:8 | JHN 20:30 | MAT 5:32 | `Ἰησοῦς` (Iesous; English: Jesus) |
| `exact_center_word` | TCG_NT | `dyn_jesus_g` | -108998 | HEB 7:23 | JHN 20:21 | MAT 15:2 | `Ἰησοῦς` (Iesous; English: Jesus) |
| `exact_center_word` | TCG_NT | `dyn_jesus_g` | -104792 | HEB 2:3 | JHN 21:5 | MAT 19:7 | `Ἰησοῦς,` (Iesous; English: Jesus) |
...
| `exact_center_word` | MT_WLC | `dyn_netanyahu_h` | -175540 | 2Chr 2:9 | Jer 40:8 | Deut 9:11 | `נְתַנְיָ֡הוּ` (ntnyhw; English: Netanyahu) |
| `exact_center_word` | LXX | `dyn_magog_g` | -314092 | 3MA 5:15 | EZK 38:2 | PSA 30:8 | `Μαγώγ,` (magog; English: Magog) |
| `exact_center_word` | LXX | `dyn_magog_g` | -91298 | 2CH 36:15 | 1CH 1:5 | 1KI 2:39 | `Μαγώγ,` (magog; English: Magog) |
