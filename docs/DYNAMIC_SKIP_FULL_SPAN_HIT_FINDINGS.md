...
| `תנין` (tnyn; English: Dragon)<br>`dyn_dragon_h` | hebrew | EBIBLE_WLC=6204591; MAM=6135698; MT_WLC=6066657; UHB=6186847; UXLC=6062411 | HEB_PBY_AHAD_HAAM=33003976; HEB_PBY_BIALIK=143129945; HEB_PBY_BRENNER=145655795 | EBIBLE_WLC=6204591 | HEB_PBY_BRENNER=145655795 |
...
| GRC_PERSEUS_ILIAD | `χριστος` (Christos; English: Christ)<br>`dyn_christ_g` | 69 | 595 | Perseus Iliad=69 | `διοσ` (dios)=2; `σε` (se)=2; `ωσ` (os)=2; `τελαμωνιοσ` (telamonios)=1; `χροοσ` (chroos)=1 |
| TR_NT | `χριστος` (Christos; English: Christ)<br>`dyn_christ_g` | 73 | 193 | 2CO 12:11=2; ACT 4:7=1; ACT 21:24=1; ACT 24:16=1; ACT 9:43=1 | `εισ` (eis)=4; `πατροσ` (patros)=2; `αυτουσ` (autous)=2; `εστιν` (estin)=2; `ιησουσ` (Iesous; English: Jesus/Joshua)=2 |
| BYZ_NT | `χριστος` (Christos; English: Christ)<br>`dyn_christ_g` | 79 | 1414 | ACT 6:9=1; ACT 13:38=1; JHN 3:26=1; JHN 6:34=1; JHN 9:15=1 | `αυτοισ` (autois)=4; `αυτουσ` (autous)=3; `τησ` (tes)=2; `τουσ` (tous)=2; `οιτινεσ` (oitines)=2 |
| TCG_NT | `χριστος` (Christos; English: Christ)<br>`dyn_christ_g` | 80 | 3289 | ACT 4:23=1; ACT 5:3=1; ACT 16:38=1; ACT 4:28=1; JHN 16:14=1 | `πιστεωσ` (pisteos)=3; `ωσ` (os)=3; `τουσ` (tous)=2; `απολυθεντεσ` (apoluthentes)=1; `νοσφισασθαι` (nosphisasthai)=1 |
| SBLGNT | `χριστος` (Christos; English: Christ)<br>`dyn_christ_g` | 85 | 737 | Acts 27:16=2; Acts 7:45=1; Acts 13:28=1; Acts 16:23=1; Acts 12:3=1 | `εισ` (eis)=6; `τησ` (tes)=4; `πατροσ` (patros)=2; `ουτωσ` (outos)=2; `υμασ` (umas)=2 |
