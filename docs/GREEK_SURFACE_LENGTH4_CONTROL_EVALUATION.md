# Greek Surface Length-4 Control Evaluation
...
Matched controls per target range from 14 to 14. The best possible add-one empirical p-values in this run are 0.066667.
