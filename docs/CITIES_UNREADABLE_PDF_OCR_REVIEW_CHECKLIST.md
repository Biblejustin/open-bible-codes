...
| 4 | cities_pdf_dp364_short | `ocr_image_only_pdf` | 6 | 6 | 0 |  | [sheet](../reports/cities_pdf_recovery_probe/unreadable_pdf_ocr_review/contact_sheets/cities_pdf_dp364_short.png) | 3_aumann_ocr_image_only | compare OCR sidecars against page images before any Aumann source-row decision |
| 5 | cities_pdf_dp365a_appendix_2 | `ocr_image_only_pdf` | 10 | 10 | 0 |  | [sheet](../reports/cities_pdf_recovery_probe/unreadable_pdf_ocr_review/contact_sheets/cities_pdf_dp365a_appendix_2.png) | 3_aumann_ocr_image_only | compare OCR sidecars against page images before any Aumann source-row decision |
| 6 | cities_pdf_dp365a_appendix_4 | `ocr_image_only_pdf` | 2 | 2 | 0 |  | [sheet](../reports/cities_pdf_recovery_probe/unreadable_pdf_ocr_review/contact_sheets/cities_pdf_dp365a_appendix_4.png) | 3_aumann_ocr_image_only | compare OCR sidecars against page images before any Aumann source-row decision |
| 7 | cities_pdf_dp365a_appendix_5 | `ocr_image_only_pdf` | 2 | 2 | 0 |  | [sheet](../reports/cities_pdf_recovery_probe/unreadable_pdf_ocr_review/contact_sheets/cities_pdf_dp365a_appendix_5.png) | 3_aumann_ocr_image_only | compare OCR sidecars against page images before any Aumann source-row decision |
| 8 | cities_pdf_dp365a_appendix_6 | `ocr_image_only_pdf` | 2 | 2 | 0 |  | [sheet](../reports/cities_pdf_recovery_probe/unreadable_pdf_ocr_review/contact_sheets/cities_pdf_dp365a_appendix_6.png) | 3_aumann_ocr_image_only | compare OCR sidecars against page images before any Aumann source-row decision |
| 9 | cities_pdf_dp365a_appendix_7 | `ocr_image_only_pdf` | 5 | 5 | 0 |  | [sheet](../reports/cities_pdf_recovery_probe/unreadable_pdf_ocr_review/contact_sheets/cities_pdf_dp365a_appendix_7.png) | 3_aumann_ocr_image_only | compare OCR sidecars against page images before any Aumann source-row decision |
| 10 | cities_pdf_dp365a_part_2_p105_111 | `ocr_image_only_pdf` | 7 | 7 | 0 |  | [sheet](../reports/cities_pdf_recovery_probe/unreadable_pdf_ocr_review/contact_sheets/cities_pdf_dp365a_part_2_p105_111.png) | 3_aumann_ocr_image_only | compare OCR sidecars against page images before any Aumann source-row decision |
| 11 | cities_pdf_wrr | `ocr_image_only_pdf` | 10 | 10 | 0 |  | [sheet](../reports/cities_pdf_recovery_probe/unreadable_pdf_ocr_review/contact_sheets/cities_pdf_wrr.png) | 4_context_pdf | review as context paper; do not import source rows without separate source decision |
