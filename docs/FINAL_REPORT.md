...
report for the main narrative. Use `docs/FINAL_REPORT_HIGHLIGHTS.md` for the
compact occurrence table, `docs/CLAIM_CATALOG.md` for current reproduction
status, `docs/CONSOLIDATED_FINDINGS.md` for the broader evidence read, and
`docs/REAL_REPORT_RUN.md` for the formal assembly and preflight rules.
