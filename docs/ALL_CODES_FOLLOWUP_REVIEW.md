...
| 23 | greek_screening | `strongest_manual_review` | `ναοσ` (naos; English: Temple) | Temple | -9 | Matt 23:17 | `ναὸς` (naos) | BYZ_NT,SBLGNT,TCG_NT,TR_NT | `α` (a) (after_match; SBLGNT) | all_source; hidden term centered on same normalized surface word; adjacent same-skip extension `α` (a) in SBLGNT (after_match) |
| 24 | greek_screening | `strongest_manual_review` | `αιμα` (aima; English: Blood) | Blood | -10 | Rev 19:13 | `αἵματι` (aimati) | BYZ_NT,SBLGNT,TCG_NT,TR_NT |  | all_source; hidden term centered on same normalized surface word |
...
| 29 | greek_screening | `center_verse_context_review` | `αιμα` (aima; English: Blood) | Blood | 2 | Matt 13:55 | `Μαριάμ` (mariam) | BYZ_NT,SBLGNT,TCG_NT,TR_NT | `τι` (ti) (before_match; TR_NT) | all_source; center verse carries exact/related surface context; adjacent same-skip extension `τι` (ti) in TR_NT (before_match) |
| 30 | greek_screening | `center_verse_context_review` | `αιμα` (aima; English: Blood) | Blood | 2 | Matt 13:55 | `Μαριάμ` (mariam) | BYZ_NT,SBLGNT,TCG_NT,TR_NT | `τι` (ti) (before_match; TR_NT) | all_source; center verse carries exact/related surface context; adjacent same-skip extension `τι` (ti) in TR_NT (before_match) |
...
| 42 | greek_screening | `hidden_path_review` | `υιοσ` (uios; English: Son) | Son | 2 | 1Cor 5:12 | `τοὺς` (tous) | BYZ_NT,SBLGNT,TCG_NT,TR_NT | `εν` (en) (before_match; TR_NT) | all_source; no surface echo required; paths audited in 4 corpora; adjacent same-skip extension `εν` (en) in TR_NT (before_match) |
...
| 53 | hebrew_screening | `center_verse_context_review` | `אדני` (dny; English: Lord) | Lord | -2 | 1Kgs 20:9 | `בֶן־הֲדַ֗ד` (bnhdd) | EBIBLE_WLC,MAM,MT_WLC,UHB,UXLC | `אדניאמר` (dnymr) (term_plus_after; UXLC) | all_source; center verse carries exact/related surface context; compound same-skip extension `אדניאמר` (dnymr) in UXLC |
...
| 55 | hebrew_screening | `center_verse_context_review` | `רומי` (rwmy; English: Rome) | Rome | 6 | Josh 22:5 | `אֶתְכֶם֮` (tkm) | EBIBLE_WLC,MAM,MT_WLC,UHB,UXLC | `תו` (tw) (before_match; UXLC) | all_source; center verse carries exact/related surface context; adjacent same-skip extension `תו` (tw) in UXLC (before_match) |
...
| 73 | hebrew_theology | `related_center_word_review` | `תורה` (twrh; English: Torah) | Torah | -7 | 2Kgs 17:20 | `יִשְׂרָאֵל֙` (yshrl) | EBIBLE_WLC,MAM,MT_WLC,UHB,UXLC | `ואח` (wch) (after_match; UXLC) | all_source; center surface word is related by concept/category flag; adjacent same-skip extension `ואח` (wch) in UXLC (after_match) |
