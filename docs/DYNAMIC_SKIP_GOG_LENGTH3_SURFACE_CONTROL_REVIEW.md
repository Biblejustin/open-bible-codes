...
- matched term universe: 25 terms, including target `γωγ`
...
| ---: | ---: | --- | --- | ---: | --- | --- |
| 1 | 25 | `εια` | False | 14,995 | `BYZ_NT:3785;SBLGNT:3702;TCG_NT:3769;TR_NT:3739` | matched control exceeds target |
| 2 | 24 | `σοσ` | False | 14,028 | `BYZ_NT:3524;SBLGNT:3418;TCG_NT:3418;TR_NT:3668` | matched control exceeds target |
| 3 | 23 | `ουα` | False | 12,929 | `BYZ_NT:3189;SBLGNT:3163;TCG_NT:3243;TR_NT:3334` | matched control exceeds target |
| 4 | 22 | `σην` | False | 12,600 | `BYZ_NT:3262;SBLGNT:3159;TCG_NT:3127;TR_NT:3052` | matched control exceeds target |
| 5 | 21 | `ευα` | False | 10,864 | `BYZ_NT:2732;SBLGNT:2727;TCG_NT:2707;TR_NT:2698` | matched control exceeds target |
| 6 | 20 | `αρω` | False | 8,747 | `BYZ_NT:2303;SBLGNT:2064;TCG_NT:2191;TR_NT:2189` | matched control exceeds target |
| 7 | 19 | `αγω` | False | 8,579 | `BYZ_NT:2174;SBLGNT:2140;TCG_NT:2116;TR_NT:2149` | matched control exceeds target |
| 8 | 18 | `κισ` | False | 7,082 | `BYZ_NT:1761;SBLGNT:1740;TCG_NT:1794;TR_NT:1787` | matched control exceeds target |
| 9 | 17 | `αψη` | False | 5,371 | `BYZ_NT:1341;SBLGNT:1300;TCG_NT:1357;TR_NT:1373` | matched control exceeds target |
| 10 | 16 | `πιε` | False | 5,277 | `BYZ_NT:1365;SBLGNT:1255;TCG_NT:1311;TR_NT:1346` | matched control exceeds target |
| 11 | 15 | `εδυ` | False | 4,567 | `BYZ_NT:1144;SBLGNT:1102;TCG_NT:1143;TR_NT:1178` | matched control exceeds target |
| 12 | 14 | `ιση` | False | 4,211 | `BYZ_NT:1097;SBLGNT:1046;TCG_NT:1058;TR_NT:1010` | matched control exceeds target |
| 13 | 13 | `ωον` | False | 3,960 | `BYZ_NT:986;SBLGNT:991;TCG_NT:979;TR_NT:1004` | matched control exceeds target |
| 14 | 12 | `ιου` | False | 3,466 | `BYZ_NT:844;SBLGNT:892;TCG_NT:861;TR_NT:869` | matched control exceeds target |
| 15 | 11 | `ηθη` | False | 2,668 | `BYZ_NT:614;SBLGNT:700;TCG_NT:690;TR_NT:664` | matched control exceeds target |
| 16 | 10 | `σημ` | False | 2,466 | `BYZ_NT:643;SBLGNT:575;TCG_NT:615;TR_NT:633` | matched control exceeds target |
| 17 | 9 | `σηθ` | False | 1,574 | `BYZ_NT:353;SBLGNT:422;TCG_NT:389;TR_NT:410` | matched control exceeds target |
| 18 | 8 | `δωσ` | False | 1,300 | `BYZ_NT:341;SBLGNT:336;TCG_NT:313;TR_NT:310` | matched control exceeds target |
| 19 | 7 | `ηχω` | False | 942 | `BYZ_NT:256;SBLGNT:226;TCG_NT:230;TR_NT:230` | matched control exceeds target |
| 20 | 6 | `αηρ` | False | 815 | `BYZ_NT:200;SBLGNT:204;TCG_NT:208;TR_NT:203` | matched control exceeds target |
| 21 | 5 | `χρω` | False | 293 | `BYZ_NT:71;SBLGNT:68;TCG_NT:85;TR_NT:69` | matched control exceeds target |
| 22 | 4 | `ιωβ` | False | 287 | `BYZ_NT:63;SBLGNT:61;TCG_NT:86;TR_NT:77` | matched control exceeds target |
| 23 | 3 | `χρη` | False | 221 | `BYZ_NT:58;SBLGNT:57;TCG_NT:57;TR_NT:49` | matched control exceeds target |
| 24 | 2 | `γαδ` | False | 76 | `BYZ_NT:14;SBLGNT:25;TCG_NT:19;TR_NT:18` | matched control exceeds target |
| 25 | 1 | `γωγ` | True | 14 | `BYZ_NT:4;SBLGNT:4;TCG_NT:4;TR_NT:2` | target term |
