...
| Project Gutenberg eBook 30 + eBook 124 | public-domain-USA split KJV+Apocrypha coverage candidate | The eBook 30 RDF metadata records `The Bible, King James Version, Complete`, `Public domain in the USA.`, and a plain-text UTF-8 format URL. The heading-level coverage probe found 66 KJV book headings in eBook 30, 14 tracked KJVA Apocrypha/deuterocanon coverage rows in eBook 124, and one extra source heading for the Epistle of Jeremiah. This makes it a possible split-source replication candidate, but no verse mapping, collation, checksum lock, or source-use policy lock exists yet. | Source-use policy lock, local ignored text import if allowed, verse mapping, book-order lock, Baruch/Epistle handling decision, collation against current eBible KJVA, checksums, term lock, and study-lock sidecar. |
