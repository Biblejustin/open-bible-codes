...
| Permutation test | Date/rabbi pairings shuffled under the declared WRR rule with recorded seeds/counts | Legacy diagnostic date-label shuffles exist, and the selected local lock now has a keep-all cap-1000 999,999-permutation run. Exact published reproduction remains caveated by source-transcription limits and the 163-distance gap. |
