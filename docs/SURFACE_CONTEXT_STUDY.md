...
- Hul (`ουλ`): TR 1,091; SBLGNT 1,059.
- Shem (`σημ`): TR 648; SBLGNT 614.
- Noah (`νωε`): TR 188; SBLGNT 154.
- Blood (`αιμα`): TR 109; SBLGNT 99.
- Son (`υιοσ`): TR 103; SBLGNT 77.
- God (`θεοσ`): TR 49; SBLGNT 46.
- Gog (`γωγ`): TR 22; SBLGNT 26.
