...
the TR_NT/SBLGNT `δοξα` row. Its maximum status is source-specific review.
...
| --- | --- | --- | --- |
| `αιμα` | `αιμα|14|forward|before_plus_term_plus_after|ναιμανο|ναιμανο` | Rev 17:6 | Luke 4:27 |
| `υιοσ` | `υιοσ|25|forward|before_plus_term|ουουιοσ|ουουιοσ` | Luke 19:9 | Matt 17:9; Matt 26:24; Mark 14:21; John 4:46 |
...
This source-only study can decide whether `αιμα` and `υιος` deserve internal
