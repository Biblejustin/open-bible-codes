...
- Opportunity hit inputs: `reports/crd/classified_hits.csv`
- Opportunity hit rows: `15,945`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `all` | 1002 | 179 | 3.358659 | 3.396015 | 204 | 94 | `yes` |
| `diagonal` | 265 | 30 | 5.300000 | 5.358948 | 55 | 13 | `yes` |
| `orthogonal` | 357 | 37 | 5.789189 | 5.853579 | 73 | 18 | `yes` |
| `same_cell` | 380 | 112 | 2.035714 | 2.058356 | 79 | 63 | `yes` |
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- |
| `same_cell` | `גוג` (Gog; English: Gog) | `מגוג` (Magog; English: Magog) | 273 | 100 | 1.638000 | 1.733333 | `yes` |
| `diagonal` | `גוג` (Gog; English: Gog) | `מגוג` (Magog; English: Magog) | 42 | 0 | -- | -- | `yes` |
| `orthogonal` | `דריוש` (Daryavesh; English: Darius) | `גוג` (Gog; English: Gog) | 26 | 2 | 2.600000 | 7.800000 | `yes` |
| `diagonal` | `דריוש` (Daryavesh; English: Darius) | `חותמ` (chwtm; English: Seal) | 25 | 0 | -- | -- | `yes` |
| `same_cell` | `כורש` (Koresh; English: Cyrus) | `דריוש` (Daryavesh; English: Darius) | 24 | 1 | 4.800000 | 14.400000 | `yes` |
...
| `diagonal` | `קרנ` (qeren; English: Horn) | `חזונ` (chzwn; English: Vision) | 18 | 1 | 3.600000 | 10.800000 | `yes` |
| `same_cell` | `חיה` (chayah; English: Beast) | `חזונ` (chzwn; English: Vision) | 17 | 5 | 2.040000 | 2.040000 | `yes` |
| `diagonal` | `דריוש` (Daryavesh; English: Darius) | `מגוג` (Magog; English: Magog) | 16 | 3 | 2.133333 | 3.386243 | `yes` |
| `orthogonal` | `כורש` (Koresh; English: Cyrus) | `דריוש` (Daryavesh; English: Darius) | 16 | 3 | 3.200000 | 3.200000 | `yes` |
| `orthogonal` | `תנינ` (tnyn; English: Dragon) | `חזונ` (chzwn; English: Vision) | 16 | 1 | 3.200000 | 9.600000 | `yes` |
| `diagonal` | `חיה` (chayah; English: Beast) | `תנינ` (tnyn; English: Dragon) | 16 | 0 | -- | -- | `yes` |
| `orthogonal` | `דריוש` (Daryavesh; English: Darius) | `תנינ` (tnyn; English: Dragon) | 15 | 3 | 2.000000 | 3.000000 | `yes` |
| `orthogonal` | `תנינ` (tnyn; English: Dragon) | `מגוג` (Magog; English: Magog) | 15 | 1 | 3.000000 | 9.523810 | `yes` |
| `orthogonal` | `גוג` (Gog; English: Gog) | `מגוג` (Magog; English: Magog) | 15 | 1 | 3.000000 | 9.523810 | `yes` |
...
| `orthogonal` | `דריוש` (Daryavesh; English: Darius) | `חזונ` (chzwn; English: Vision) | 13 | 1 | 2.600000 | 7.800000 | `yes` |
| `orthogonal` | `חותמ` (chwtm; English: Seal) | `חזונ` (chzwn; English: Vision) | 12 | 1 | 2.400000 | 7.200000 | `yes` |
| `orthogonal` | `קרנ` (qeren; English: Horn) | `מגוג` (Magog; English: Magog) | 11 | 0 | -- | -- | `yes` |
| `diagonal` | `כורש` (Koresh; English: Cyrus) | `גוג` (Gog; English: Gog) | 10 | 2 | 1.000000 | 3.000000 | `no` |
| `orthogonal` | `מגוג` (Magog; English: Magog) | `חזונ` (chzwn; English: Vision) | 10 | 2 | 1.000000 | 3.174603 | `no` |
| `orthogonal` | `כורש` (Koresh; English: Cyrus) | `תנינ` (tnyn; English: Dragon) | 10 | 1 | 2.000000 | 6.000000 | `yes` |
| `orthogonal` | `כורש` (Koresh; English: Cyrus) | `נביא` (navi; English: Prophet) | 10 | 1 | 2.000000 | 6.000000 | `yes` |
| `orthogonal` | `תנינ` (tnyn; English: Dragon) | `חותמ` (chwtm; English: Seal) | 10 | 1 | 2.000000 | 6.000000 | `yes` |
...
| `diagonal` | `חיה` (chayah; English: Beast) | `חותמ` (chwtm; English: Seal) | 7 | 2 | 1.400000 | 2.100000 | `yes` |
| `diagonal` | `קרנ` (qeren; English: Horn) | `חותמ` (chwtm; English: Seal) | 6 | 3 | 0.800000 | 1.200000 | `no` |
| `diagonal` | `דריוש` (Daryavesh; English: Darius) | `נביא` (navi; English: Prophet) | 6 | 1 | 1.200000 | 3.600000 | `yes` |
