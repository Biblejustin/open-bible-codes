...
| 19 | all_source | `yhwh_h` | YHWH | 3 | 10 | 2Kgs 25:13 | `יהוה` | not_unusual |
...
| 3 | all_source | `lord_h` | Lord | -2 | 7 | 1Kgs 20:9 | `הדד` | not_unusual |
...
| 16 | all_source | `temple_h` | Temple | -2 | 7 | 2Kgs 23:4 | `הכלימ` | not_unusual |
...
| Rank | Scope | Term | Concept | Skip | Span | Center | Center word | Control |
| ---: | --- | --- | --- | ---: | ---: | --- | --- | --- |
| 1 | all_source | `rome_h` | Rome | -6 | 19 | 1Kgs 7:40 | `המזרקות` | not_unusual |
| 2 | all_source | `rome_h` | Rome | 6 | 19 | Josh 22:5 | `אתכמ` | not_unusual |
| 3 | all_source | `rome_h` | Rome | -8 | 25 | Gen 42:7 | `באתמ` | not_unusual |
| 4 | all_source | `rome_h` | Rome | -9 | 28 | Gen 7:19 | `על` | not_unusual |
...
| 9 | all_source | `rome_h` | Rome | 16 | 49 | Isa 29:18 | `דברי` | not_unusual |
...
| 3 | all_source | `timothy_h` | Timothy | 16 | 81 | Gen 30:20 | `שמו` | paired_uncorrected_p_le_0.05 |
...
| 8 | all_source | `second_death_h` | Second Death | -92 | 461 | Gen 46:27 | `לבית` | paired_uncorrected_p_le_0.05 |
...
| 6 | all_source | `rome_h` | Rome | 32 | 97 | Isa 38:15 | `על` | not_unusual |
...
| 12 | all_source | `rome_alt_h` | Rome | 39 | 118 | Prov 13:15 | `חנ` | not_unusual |
| 13 | all_source | `rome_alt_h` | Rome | 40 | 121 | 1Sam 23:20 | `לרדת` | not_unusual |
| 14 | all_source | `rome_alt_h` | Rome | -41 | 124 | Deut 20:7 | `האיש` | not_unusual |
...
| 18 | all_source | `rome_h` | Rome | 44 | 133 | Isa 2:16 | `כל` | not_unusual |
...
| 7 | all_source | `second_death_h` | Second Death | -69 | 346 | Ps 99:6 | `יהוה` | paired_uncorrected_p_le_0.05 |
| 8 | all_source | `second_death_h` | Second Death | -73 | 366 | Num 11:16 | `מועד` | paired_uncorrected_p_le_0.05 |
| 9 | all_source | `second_death_h` | Second Death | 78 | 391 | 2Kgs 17:39 | `יהוה` | paired_uncorrected_p_le_0.05 |
...
| Rank | Scope | Term | Concept | Skip | Span | Center | Center word | Control |
| ---: | --- | --- | --- | ---: | ---: | --- | --- | --- |
| 1 | all_source | `second_death_h` | Second Death | -2 | 11 | Jer 51:39 | `שנת` | paired_uncorrected_p_le_0.05 |
| 2 | all_source | `second_death_h` | Second Death | -2 | 11 | Jer 51:57 | `שנת` | paired_uncorrected_p_le_0.05 |
...
| 11 | all_source | `second_death_h` | Second Death | 11 | 56 | Prov 22:18 | `נעימ` | paired_uncorrected_p_le_0.05 |
...
| 18 | all_source | `timothy_h` | Timothy | 29 | 146 | Esth 4:14 | `ובית` | paired_uncorrected_p_le_0.05 |
