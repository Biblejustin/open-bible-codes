...
| `ανομια` (anomia; English: Lawlessness) | Matt 7:23 | 20 | forward | TR_NT,BYZ_NT,TCG_NT,SBLGNT | TR_NT:`Οὐδέποτε` (oudepote; English: never); BYZ_NT:`ουδεποτε` (oudepote; English: never); TCG_NT:`Οὐδέποτε` (oudepote; English: never); SBLGNT:`Οὐδέποτε` (oudepote; English: never) |
