...
def write_markdown(
    ...
    lines = [
        ...
        "plain-text files. It does not decide the canonical WRR pair table; it only",
        "shows whether the available source files directly expose the commonly cited",
        "published distance count.",
        "",
        "## Summary",
        "",
        "| Item | Count |",
