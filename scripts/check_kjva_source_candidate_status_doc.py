...
REQUIRED_PHRASES = (
    ...
    "public-domain-USA KJV-only coverage outcome",
    "The Bible, King James Version, Complete",
    "Public domain in the USA.",
    "66 KJV book headings and 0 Apocrypha/deuterocanon book headings",
    "public-domain KJV-only control candidate",
    "not as an independent KJVA/apocrypha bridge source",
