...
from scripts import (
    ...
    check_cities_source_page_line_crop_band_review_html_doc,
    ...
    check_cities_source_page_line_crop_priority_review_html_doc,
    ...
    check_kjva_no_input_handoff_status_doc,
    check_kjva_public_handoff_docs,
    ...
    check_kjva_source_policy_blocker_packet_doc,
...
DEFAULT_REQUIRED_PATHS = [
    ...
    "protocols/cities_source_page_line_crop_band_review_html.toml",
    ...
    "protocols/cities_source_page_line_crop_priority_review_html.toml",
    ...
    "docs/STRONGEST_CANDIDATE_DEEP_DIVE.md",
    ...
    "reports/kjva_gutenberg_source_lock_prep/book_shape.csv",
    ...
    "reports/kjva_source_policy_blocker_packet/policy_options.csv",
    ...
    "reports/kjva_no_input_handoff_status/status.csv",
    ...
    "reports/kjva_hakkaac_apocrypha_marker_coverage/book_marker_coverage.csv",
    "reports/kjva_hakkaac_apocrypha_marker_coverage/chapter_marker_coverage.csv",
    "reports/kjva_hakkaac_apocrypha_marker_coverage/summary.csv",
    "reports/kjva_hakkaac_apocrypha_marker_coverage/manifest.json",
    "reports/kjva_hakkaac_apocrypha_collation/verse_collation.csv",
    "reports/kjva_hakkaac_apocrypha_collation/book_collation.csv",
    ...
    "scripts/build_cities_source_page_ocr_review_html.py",
    "scripts/check_cities_source_page_ocr_review_html_doc.py",
    "scripts/build_cities_source_page_line_crop_packet.py",
    ...
    "scripts/build_cities_source_page_line_crop_band_review_html.py",
    "scripts/check_cities_source_page_line_crop_band_review_html_doc.py",
    ...
    "scripts/check_cities_source_page_line_crop_contact_sheet_doc.py",
    ...
    "scripts/build_cities_source_page_line_crop_priority_review_html.py",
    "scripts/check_cities_source_page_line_crop_priority_review_html_doc.py",
...
def main(argv: list[str] | None = None) -> int:
    ...
    kjva_gutenberg_candidate_source_audit_doc_failures = (
        check_kjva_gutenberg_candidate_source_audit_doc.validate_kjva_gutenberg_candidate_source_audit_doc(
            root / check_kjva_gutenberg_candidate_source_audit_doc.DEFAULT_DOC
        )
    )
    if kjva_gutenberg_candidate_source_audit_doc_failures:
        failures.append(
            "KJVA Gutenberg source audit doc failures: "
            + "; ".join(kjva_gutenberg_candidate_source_audit_doc_failures)
        )

    kjva_gutenberg_book_coverage_probe_doc_failures = (
        check_kjva_gutenberg_book_coverage_probe_doc.validate_kjva_gutenberg_book_coverage_probe_doc(
            root / check_kjva_gutenberg_book_coverage_probe_doc.DEFAULT_DOC
        )
    )
    if kjva_gutenberg_book_coverage_probe_doc_failures:
        failures.append(
    ...
    kjva_gutenberg_source_lock_prep_doc_failures = (
        check_kjva_gutenberg_source_lock_prep_doc.validate_kjva_gutenberg_source_lock_prep_doc(
            root / check_kjva_gutenberg_source_lock_prep_doc.DEFAULT_DOC
        )
    )
    if kjva_gutenberg_source_lock_prep_doc_failures:
        failures.append(
    ...
    kjva_gutenberg_source_lock_blocker_packet_doc_failures = (
        check_kjva_gutenberg_source_lock_blocker_packet_doc.validate_kjva_gutenberg_source_lock_blocker_packet_doc(
            root / check_kjva_gutenberg_source_lock_blocker_packet_doc.DEFAULT_DOC
        )
    )
    if kjva_gutenberg_source_lock_blocker_packet_doc_failures:
        failures.append(
    ...
    kjva_source_policy_blocker_packet_doc_failures = (
        check_kjva_source_policy_blocker_packet_doc.validate_kjva_source_policy_blocker_packet_doc(
            root / check_kjva_source_policy_blocker_packet_doc.DEFAULT_DOC
        )
    )
    if kjva_source_policy_blocker_packet_doc_failures:
        failures.append(
    ...
    kjva_no_input_handoff_status_doc_failures = (
        check_kjva_no_input_handoff_status_doc.validate_kjva_no_input_handoff_status_doc(
            root / check_kjva_no_input_handoff_status_doc.DEFAULT_DOC
        )
    )
    if kjva_no_input_handoff_status_doc_failures:
        failures.append(
            "KJVA no-input handoff status failures: "
            + "; ".join(kjva_no_input_handoff_status_doc_failures)
        )

    kjva_public_handoff_doc_failures = (
        check_kjva_public_handoff_docs.validate_kjva_public_handoff_docs(root)
    )
    if kjva_public_handoff_doc_failures:
        failures.append(
            "KJVA public handoff doc failures: "
            + "; ".join(kjva_public_handoff_doc_failures)
        )
    ...
    kjva_hakkaac_apocrypha_marker_coverage_doc_failures = (
        check_kjva_hakkaac_apocrypha_marker_coverage_doc.validate_kjva_hakkaac_apocrypha_marker_coverage_doc(
            root / check_kjva_hakkaac_apocrypha_marker_coverage_doc.DEFAULT_DOC
        )
    )
    if kjva_hakkaac_apocrypha_marker_coverage_doc_failures:
        failures.append(
            "KJVA Hakkaac marker coverage failures: "
            + "; ".join(kjva_hakkaac_apocrypha_marker_coverage_doc_failures)
        )

    kjva_hakkaac_apocrypha_collation_doc_failures = (
        check_kjva_hakkaac_apocrypha_collation_doc.validate_kjva_hakkaac_apocrypha_collation_doc(
            root / check_kjva_hakkaac_apocrypha_collation_doc.DEFAULT_DOC
        )
    )
    if kjva_hakkaac_apocrypha_collation_doc_failures:
        failures.append(
            "KJVA Hakkaac collation failures: "
            + "; ".join(kjva_hakkaac_apocrypha_collation_doc_failures)
        )

    kjva_hakkaac_source_lock_decision_packet_doc_failures = (
        check_kjva_hakkaac_source_lock_decision_packet_doc.validate_kjva_hakkaac_source_lock_decision_packet_doc(
            root / check_kjva_hakkaac_source_lock_decision_packet_doc.DEFAULT_DOC
        )
    )
    if kjva_hakkaac_source_lock_decision_packet_doc_failures:
        failures.append(
            "KJVA Hakkaac source-lock decision packet failures: "
            + "; ".join(kjva_hakkaac_source_lock_decision_packet_doc_failures)
        )

    kjva_open_bibles_candidate_source_audit_doc_failures = (
        check_kjva_open_bibles_candidate_source_audit_doc.validate_kjva_open_bibles_candidate_source_audit_doc(
            root / check_kjva_open_bibles_candidate_source_audit_doc.DEFAULT_DOC
        )
    )
    if kjva_open_bibles_candidate_source_audit_doc_failures:
        failures.append(
            "KJVA Open-Bibles source audit doc failures: "
            + "; ".join(kjva_open_bibles_candidate_source_audit_doc_failures)
        )
    ...
    wrr_method_lane_wide_skip_probe_doc_failures = (
        check_wrr_method_lane_wide_skip_probe_doc.validate_wide_skip_probe_doc(
            check_wrr_method_lane_wide_skip_probe_doc.DEFAULT_DOC
        )
    )
    if wrr_method_lane_wide_skip_probe_doc_failures:
        failures.append(
    ...
    if cities_source_transcription_review_worksheet_doc_failures:
        failures.append(
    ...
    cities_source_page_contact_sheet_doc_failures = (
        check_cities_source_page_contact_sheet_doc.validate_cities_source_page_contact_sheet_doc(
            check_cities_source_page_contact_sheet_doc.DEFAULT_DOC
        )
    )
    if cities_source_page_contact_sheet_doc_failures:
        failures.append(
            "Cities source-page contact sheet doc failures: "
            + "; ".join(cities_source_page_contact_sheet_doc_failures)
        )

    cities_source_page_ocr_review_packet_doc_failures = (
        check_cities_source_page_ocr_review_packet_doc.validate_cities_source_page_ocr_review_packet_doc(
            check_cities_source_page_ocr_review_packet_doc.DEFAULT_DOC
        )
    )
    if cities_source_page_ocr_review_packet_doc_failures:
        failures.append(
            "Cities source-page OCR review packet doc failures: "
            + "; ".join(cities_source_page_ocr_review_packet_doc_failures)
        )

    cities_source_page_ocr_review_html_doc_failures = (
        check_cities_source_page_ocr_review_html_doc.validate_cities_source_page_ocr_review_html_doc(
            check_cities_source_page_ocr_review_html_doc.DEFAULT_DOC
        )
    )
    if cities_source_page_ocr_review_html_doc_failures:
        failures.append(
            "Cities source-page OCR review HTML doc failures: "
            + "; ".join(cities_source_page_ocr_review_html_doc_failures)
        )

    cities_source_page_line_crop_packet_doc_failures = (
        check_cities_source_page_line_crop_packet_doc.validate_cities_source_page_line_crop_packet_doc(
            check_cities_source_page_line_crop_packet_doc.DEFAULT_DOC
        )
    )
    if cities_source_page_line_crop_packet_doc_failures:
        failures.append(
            "Cities source-page line crop packet doc failures: "
            + "; ".join(cities_source_page_line_crop_packet_doc_failures)
        )

    cities_source_page_line_crop_band_map_doc_failures = (
        check_cities_source_page_line_crop_band_map_doc.validate_cities_source_page_line_crop_band_map_doc(
            check_cities_source_page_line_crop_band_map_doc.DEFAULT_DOC
        )
    )
    if cities_source_page_line_crop_band_map_doc_failures:
        failures.append(
    ...
    cities_source_page_line_crop_band_review_html_doc_failures = (
        check_cities_source_page_line_crop_band_review_html_doc.validate_cities_source_page_line_crop_band_review_html_doc(
            check_cities_source_page_line_crop_band_review_html_doc.DEFAULT_DOC
        )
    )
    if cities_source_page_line_crop_band_review_html_doc_failures:
        failures.append(
            "Cities source-page line-crop band HTML doc failures: "
            + "; ".join(cities_source_page_line_crop_band_review_html_doc_failures)
        )
    ...
    if cities_source_page_line_crop_band_review_worksheet_doc_failures:
        failures.append(
            "Cities source-page line-crop band worksheet doc failures: "
            + "; ".join(
                cities_source_page_line_crop_band_review_worksheet_doc_failures
            )
        )

    cities_source_page_line_crop_contact_sheet_doc_failures = (
        check_cities_source_page_line_crop_contact_sheet_doc.validate_cities_source_page_line_crop_contact_sheet_doc(
            check_cities_source_page_line_crop_contact_sheet_doc.DEFAULT_DOC
        )
    )
    if cities_source_page_line_crop_contact_sheet_doc_failures:
        failures.append(
            "Cities source-page line-crop contact sheet doc failures: "
            + "; ".join(cities_source_page_line_crop_contact_sheet_doc_failures)
        )

    cities_source_page_line_crop_review_html_doc_failures = (
        check_cities_source_page_line_crop_review_html_doc.validate_cities_source_page_line_crop_review_html_doc(
            check_cities_source_page_line_crop_review_html_doc.DEFAULT_DOC
        )
    )
    if cities_source_page_line_crop_review_html_doc_failures:
        failures.append(
            "Cities source-page line-crop HTML doc failures: "
            + "; ".join(cities_source_page_line_crop_review_html_doc_failures)
        )

    cities_source_page_line_crop_triage_doc_failures = (
        check_cities_source_page_line_crop_triage_doc.validate_cities_source_page_line_crop_triage_doc(
            check_cities_source_page_line_crop_triage_doc.DEFAULT_DOC
        )
    )
    if cities_source_page_line_crop_triage_doc_failures:
        failures.append(
    ...
    cities_source_page_line_crop_priority_contact_sheet_doc_failures = (
        check_cities_source_page_line_crop_priority_contact_sheet_doc.validate_cities_source_page_line_crop_priority_contact_sheet_doc(
            check_cities_source_page_line_crop_priority_contact_sheet_doc.DEFAULT_DOC
        )
    )
    if cities_source_page_line_crop_priority_contact_sheet_doc_failures:
        failures.append(
    ...
    cities_source_page_line_crop_priority_review_html_doc_failures = (
        check_cities_source_page_line_crop_priority_review_html_doc.validate_cities_source_page_line_crop_priority_review_html_doc(
            check_cities_source_page_line_crop_priority_review_html_doc.DEFAULT_DOC
        )
    )
    if cities_source_page_line_crop_priority_review_html_doc_failures:
        failures.append(
            "Cities source-page line-crop priority HTML doc failures: "
            + "; ".join(cities_source_page_line_crop_priority_review_html_doc_failures)
        )
    ...
    if cities_source_page_line_crop_review_worksheet_doc_failures:
        failures.append(
            "Cities source-page line-crop worksheet doc failures: "
            + "; ".join(cities_source_page_line_crop_review_worksheet_doc_failures)
        )
