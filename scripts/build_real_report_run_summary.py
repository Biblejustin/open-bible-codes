...
def write_summary(
    ...
    *,
    ...
    lines = [
        ...
        "- WRR 1994 source/import/count smoke audit",
...
def wrr_audit_section(
    ...
    lines = [
        ...
        "ignored local term file, counts the rows in Koren Genesis, and runs smoke",
        "controls. It is not the WRR corrected-distance statistic.",
        "",
        "| Source | SHA-256 |",
        "| --- | --- |",
        ...
        f"| Perturbation rows with sampled hits | {int_value(perturbations, 'rows_with_hits'):,} |",
        f"| Perturbation rows with sample < 10 valid | {int_value(perturbations, 'rows_with_sample_under_10_valid'):,} |",
        ...
        "163-distance statement are treated here as distinct quantities. The audit",
        "still lacks the exact eligibility path from candidate pairs to defined",
        "corrected distances.",
        "",
