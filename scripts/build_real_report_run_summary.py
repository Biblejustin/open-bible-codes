...
def write_summary(
    ...
    *,
    ...
    lines = [
        ...
        "- Torah-code WRR-adjacent source-shape audits for Gans communities, American presidents, Witztum birth dates, Israeli prime ministers, Cities source-chain files, event/object experiment pages, and under-construction placeholders",
        "- report file index",
        "",
        "## Current Read",
        "",
