...
def write_package_readme(out_dir: Path, copied: list[CopiedFile]) -> None:
    lines = [
        ...
        "6. `docs/STRONGEST_CANDIDATE_DEEP_DIVE.md`",
        "7. `docs/WRR_NO_INPUT_HANDOFF_STATUS.md`",
        "8. `docs/KJVA_NO_INPUT_HANDOFF_STATUS.md`",
        "9. `docs/CITIES_NO_INPUT_HANDOFF_STATUS.md`",
        "10. `reports/real_report_run/summary.md`",
        "",
        "Package files:",
        "",
