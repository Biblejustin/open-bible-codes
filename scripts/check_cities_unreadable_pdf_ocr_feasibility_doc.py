...
from scripts import build_cities_unreadable_pdf_ocr_feasibility as builder
...
def validate_summary_csv(
    ...
    if rows != expected_rows:
        failures.append("summary CSV summary rows drifted from row totals")
    return failures
...
def validate_manifest(
    ...
    expected = {
        "tool": "build_cities_unreadable_pdf_ocr_feasibility.py",
