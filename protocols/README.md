...
English source-basis metadata, validates expanded-strata tooling docs and
future study-mapping CSV schemas, builds the generated report index, and
writes `reports/real_report_run/summary.md`.
