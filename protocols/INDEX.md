...
| real_report_run | Formal report assembly run over locked STEP_TAHOT, Greek exact-center, doxa follow-ups,... | 48 | terms/bible_and_science_codes_terms.csv, terms/bible_code_digest_claim_terms.csv, terms... | reports, reports/all_codes_compound_extension_confirmatory, reports/all_codes_compound_... | `real_report_run.toml` |
...
| wrr_cross_pair_grid | Build the WRR2 appellation/date cross-pair grid and run cap-250 corrected-distance diag... | 3 |  | reports/wrr_1994 | `wrr_cross_pair_grid.toml` |
