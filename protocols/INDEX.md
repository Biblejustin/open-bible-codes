...
| cities_source_page_line_crop_priority_review_html | Build ignored local HTML for Cities source-page line-crop priority review. | 1 |  | reports/cities_pdf_recovery_probe | `cities_source_page_line_crop_priority_review_html.toml` |
...
| kjva_no_input_handoff_status | Write the consolidated KJVA no-input handoff status without approving source use or pro... | 1 |  | reports/kjva_no_input_handoff_status | `kjva_no_input_handoff_status.toml` |
...
| event_object_experiments_source_audit | Audit Torah-code.org Sons of Haman, Pumbedita, Auschwitz, and Ark source files without ... | 2 |  | reports/wrr_1994 | `event_object_experiments_source_audit.toml` |
...
| kjva_gutenberg_candidate_source_audit | Audit Project Gutenberg eBook 30 and eBook 124 RDF metadata as a public-domain split KJ... | 1 |  | reports/kjva_gutenberg_candidate_source | `kjva_gutenberg_candidate_source_audit.toml` |
| kjva_hakkaac_apocrypha_boundary_candidate | Audit Hakkaac KJV Apocrypha pages as marker-only candidates for resolving KJVA source-l... | 1 |  | reports/kjva_hakkaac_apocrypha_boundary_candidate | `kjva_hakkaac_apocrypha_boundary_candidate.toml` |
| kjva_hakkaac_apocrypha_marker_coverage | Audit all Hakkaac KJV Apocrypha pages as marker-only coverage candidates without import... | 1 |  | reports/kjva_hakkaac_apocrypha_marker_coverage | `kjva_hakkaac_apocrypha_marker_coverage.toml` |
...
| real_report_run | Formal report assembly run over locked STEP_TAHOT, Greek exact-center, doxa follow-ups,... | 77 | terms/bible_and_science_codes_terms.csv, terms/bible_code_digest_claim_terms.csv, terms... | reports, reports/all_codes_compound_extension_confirmatory, reports/all_codes_compound_... | `real_report_run.toml` |
...
| critical_omission_followups | Follow-up analyses on TR-vs-SBLGNT omission breaks. | 9 | terms/modern_names_dates.csv, terms/pericope_adulterae_frequency_controls.csv, terms/pe... | reports, reports/critical_omission_breaks_null | `critical_omission_followups.toml` |
...
| wrr_audit_counts | WRR2 imported-term count, same-record pair smoke, and current repo-defined diagnostic s... | 62 |  | reports/wrr_1994 | `wrr_audit_counts.toml` |
