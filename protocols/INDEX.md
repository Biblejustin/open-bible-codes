...
| critical_omission_followups | Follow-up analyses on TR-vs-SBLGNT omission breaks. | 7 | terms/modern_names_dates.csv, terms/pericope_adulterae_frequency_controls.csv, terms/pe... | reports, reports/critical_omission_breaks_null | `critical_omission_followups.toml` |
