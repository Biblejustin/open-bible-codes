...
def test_download_sblgnt_rejects_non_list_api_root(tmp_path, monkeypatch) -> None:
    ...
    with pytest.raises(SystemExit, match="SBLGNT GitHub API listing JSON root must be a list"):
        downloader.main()
