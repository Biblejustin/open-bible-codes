...
def test_main_writes_word_edge_summary(tmp_path: Path) -> None:
    ...
    hits.write_text(
        "pattern_type,corpus_label,corpus,term_id,concept,category,normalized_term,direction,center_ref\n"
        "acrostic,MT_WLC,OSHB,yhwh,YHWH,word_edge,יהוה,forward,Esth 5:4\n",
        encoding="utf-8",
    )
